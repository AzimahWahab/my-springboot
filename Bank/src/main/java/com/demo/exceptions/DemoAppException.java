...
/**
 * Custom exception class for the Demo Application.
 * <p>
 * This exception can be used to indicate specific error conditions within the
 * application's business logic.  It extends {@link RuntimeException},
 * making it an unchecked exception. This means it does not need to be
 * explicitly declared in the `throws` clause of a method.
 */
